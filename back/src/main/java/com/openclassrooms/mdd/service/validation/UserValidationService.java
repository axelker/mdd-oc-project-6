...
public class UserValidationService {
    ...
    /**
     * Validates if a username is already taken by another user.
     * <p>
     * This method checks the repository to see if the username is already in use. If it is, an exception
